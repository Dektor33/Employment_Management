...
namespace ServerLibrary.Repositories.Implementations
{
    public class VacationTypeRepository(AppDbContext appDbContext) : IGenericRepositoryInterface<VacationType>
    {
        ...
        {
            if (!await CheckName(item.Name!)) return new GeneralResponse(false, "VacationType Type already added");
        ...
        private static GeneralResponse NotFound() => new(false, "Sorry Vacation Type data not found");
